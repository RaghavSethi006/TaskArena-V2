...
function RankBadge({ rank }: { rank: number }) {
  if (rank === 1) return <span>Ã°Å¸Â¥â€¡</span>
  if (rank === 2) return <span>Ã°Å¸Â¥Ë†</span>
  if (rank === 3) return <span>Ã°Å¸Â¥â€°</span>
  return <span className="text-tx3 font-mono">#{rank}</span>
}

// Ã¢â€â‚¬Ã¢â€â‚¬ Auth Gate Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
function AuthGate() {
  ...
  const handleSubmit = async () => {
    ...
    // No need to call onDone Ã¢â‚¬â€ onAuthStateChanged will update the user state
  }
  ...
  return (
    <div className="rounded-[12px] border border-b1 bg-s1 p-6 max-w-sm mx-auto mt-4">
      ...
      <div className="space-y-2">
        ...
        >
          {loading ? "Please waitÃ¢â‚¬Â¦" : mode === "login" ? "Sign In" : "Create Account"}
        </button>
...
// Ã¢â€â‚¬Ã¢â€â‚¬ Lobby leaderboard table Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬ Main lobbies view Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
function LobbiesView({ uid, displayName, meStats }: { uid: string; displayName: string; meStats: MeStats | undefined }) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      toast.success(`Lobby "${lobby.name}" created Ã¢â‚¬â€ code: ${lobby.code}`)
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div className="flex gap-1">
          {(["mine", "browse"] as const).map((v) => (
            ...
            >
              {v === "mine" ? `My Lobbies (${lobbies.length})` : "Ã°Å¸Å’Â Browse Community"}
            </button>
          ))}
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[240px_1fr] gap-3">
        ...
        <div className="rounded-[10px] border border-b1 bg-s1 p-2 space-y-1">
          ...
          {loading ? (
            <p className="text-[11px] text-tx3 px-2">LoadingÃ¢â‚¬Â¦</p>
          ) : lobbies.length === 0 ? (
        ...
        <div>
          {!activeLobbyId ? (
            ...
            <div className="rounded-[10px] border border-b1 bg-s1 p-4 text-[12px] text-tx3">LoadingÃ¢â‚¬Â¦</div>
          ) : (
            <>
              <div className="flex items-center justify-between mb-2">
                <div>
                  ...
                  <p className="text-[10px] text-tx3 font-mono mt-0.5">
                    {detail.member_count} members Ã‚Â· code: {detail.code}
                    {detail.invite_only ? " Ã‚Â· Ã°Å¸â€â€™ invite only" : ""}
                  </p>
                </div>
                <button
                  type="button"
      ...
      <div className="rounded-[10px] border border-b1 bg-s1 overflow-hidden">
        <div className="px-3 py-2 border-b border-b1">
          ...
          <p className="text-[10px] text-tx3 mt-0.5">
            Public lobbies anyone can join ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â great for courses, universities, or friend groups.
          </p>
        </div>
        {communityLoading ? (
          <p className="text-[11px] text-tx3 p-4">LoadingÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦</p>
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] font-mono text-tx3 mt-0.5">
                      ...
                      {lobby.invite_only ? " Ãƒâ€šÃ‚Â· ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬â„¢ invite only" : ""}
                    </p>
                  </div>
                  {isAlreadyMember ? (
                    <button
                    ...
                    >
                      {lobby.invite_only ? "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬â„¢ Invite Only" : "Join"}
                    </button>
                  )}
                </div>
              )
        ...
        <DialogContent className="bg-s1 border-b1 rounded-[12px]">
            ...
            <div>
              ...
              <div className="flex gap-2">
                {(["private", "community"] as const).map((t) => (
                  ...
                  >
                    {t === "private" ? "Ã°Å¸â€Â Private" : "Ã°Å¸Å’Â Community"}
                  </button>
                ))}
              </div>
              <p className="text-[10px] text-tx3 mt-1">
                {newType === "private"
                  ...
                  : "Visible to everyone Ã¢â‚¬â€ good for course-wide or uni-wide boards."}
              </p>
            </div>
            <div className="flex items-center justify-between rounded-[8px] border border-b1 bg-s2/40 px-3 py-2.5">
              <div>
          ...
          <DialogFooter>
            ...
            <button type="button" disabled={actionLoading} onClick={() => void handleCreate()} className="h-8 px-3 rounded-[7px] bg-blue-500 text-white hover:bg-blue-600 disabled:opacity-40">
              {actionLoading ? "CreatingÃ¢â‚¬Â¦" : "Create"}
            </button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="bg-s1 border-b1 rounded-[12px]">
          ...
          <DialogFooter>
            ...
            <button type="button" disabled={actionLoading || joinCode.length !== 6} onClick={() => void handleJoin()} className="h-8 px-3 rounded-[7px] bg-blue-500 text-white hover:bg-blue-600 disabled:opacity-40">
              {actionLoading ? "JoiningÃ¢â‚¬Â¦" : "Join"}
            </button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
...
export default function LeaderboardPage() {
  ...
  return (
    <div className="animate-fadeUp">
      ...
      {mainTab !== "lobbies" && (
        <div className="grid grid-cols-1 xl:grid-cols-[2.2fr_1fr] gap-3">
          <div className="rounded-[10px] border border-b1 bg-s1 overflow-hidden">
            <div className="grid grid-cols-[36px_1fr_90px_70px_70px_80px_70px] px-3 py-2 text-[10px] text-tx3 font-mono uppercase tracking-[0.8px] border-b border-b1">
              <span>#</span>
              <span>Name</span>
              <span>XP</span>
              <span>Tasks</span>
            ...
            {rankingsQuery.isLoading ? (
              <div className="px-3 py-4 text-[12px] text-tx3">Loading...</div>
            ) : rankingsQuery.error ? (
              <div className="px-3 py-4 text-[12px] text-rose-300">
                {rankingsQuery.error instanceof Error ? rankingsQuery.error.message : "Failed to load leaderboard."}
              </div>
            ) : (
              <div className="divide-y divide-b1">
                {(rankingsQuery.data ?? []).map((entry) => (
                  <div
                    key={entry.user_id}
                    className="grid grid-cols-[36px_1fr_90px_70px_70px_80px_70px] px-3 py-2 text-[12px] items-center hover:bg-s2/40"
                  >
                    <span className="text-tx2 font-mono">
                      <RankBadge rank={entry.rank} />
                    </span>
                    <span className="text-tx truncate">{entry.name}</span>
                    ...
                    <span className="text-tx3 font-mono">Lv.{entry.level}</span>
                  </div>
                ))}
              </div>
            )}
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ Lobbies tab Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
      {mainTab === "lobbies" && (
        user === undefined ? (
          <p className="text-[12px] text-tx3">LoadingÃ¢â‚¬Â¦</p>
        ) : user === null ? (
          <AuthGate />
        ) : (
          <LobbiesView
